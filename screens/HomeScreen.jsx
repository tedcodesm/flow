...
const HomeScreen = () => {
  ...
  return (
    <View className="flex-1 bg-gray-200 relative">
      ...
      {/* Header */}
      <View className="w-full px-4 py-4 flex-row justify-between bg-[#14213D] h-40 rounded-b-lg">
      ...
      >
        ...
        <View className="gap-5 py-4 bg-white rounded-lg px-4">
          <View className="flex-row justify-center">
            ...
            <Text className="font-semibold w-1/2 text-center text-lg">Rent</Text>
          </View>
          ...
          <TouchableOpacity className="bg-[#14213D] py-3 rounded-full">
        ...
        <ImageBackground
          ...
          style={{ opacity: 0.7 }} // Android-safe opacity
          className="w-full px-4 py-2 flex-row justify-between items-center h-20 rounded-lg mt-4"
        >
          <View>
            <Text className="font-semibold text-black text-2xl">Save 15%</Text>
            <Text className="text-white text-lg">Limited Time Offer signup Now</Text>
          </View>

          <TouchableOpacity className="border rounded-full py-2 px-4 border-gray-600">
        ...
        <View className="flex-row justify-between items-center px-2 py-3">
          <Text className="font-bold text-2xl text-black">Featured Property</Text>
